...
The next three boards show on the the pitch-based (left) and timbre-based (right) self-similarity matrices for a performance of each artist. The data is normalisation of distance are Euclidean based and root mean square is the summary statistic.<br><br>
...
top = textGrob("Stevie Ray Vaughan - Pride and Joy Live",gp=gpar(fontsize=28,font=1)))
```
</div>
...
<iframe src="https://open.spotify.com/embed/track/0uco0wQkB909zpPlHvu5Cc" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>

<iframe src="https://open.spotify.com/embed/track/50DMG6AvtNzbrxMc62w6ph" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>

<iframe src="https://open.spotify.com/embed/track/593SUshyuymkyDYbLVBMfr" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
<iframe src="https://open.spotify.com/embed/track/3Vs6cdkM3qIWItjoiiI5p2" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>

<iframe src="https://open.spotify.com/embed/track/5w8Ti9LEgtN2wXnJ4W4qpI" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>

<iframe src="https://open.spotify.com/embed/track/5WMKS1iDfugyLhfibIlR51" width="249" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
### And plot the songs using the new features {data-commentary-width=400}
